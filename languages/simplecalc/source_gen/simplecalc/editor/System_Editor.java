...
public class System_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_dmikla_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_dmikla_a0(editorContext, node));
    return editorCell;
  }

  private EditorCell createRefNode_dmikla_a0(EditorContext editorContext, SNode node) {
    CellProviderWithRole provider = new RefNodeCellProvider(node, editorContext);
    provider.setRole("rootNamespace");
    provider.setNoTargetText("<no rootNamespace>");
