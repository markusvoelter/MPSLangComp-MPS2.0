...
public class Module_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_iuuvkg_b0(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNodeList_iuuvkg_b1a(editorContext, node));
    return editorCell;
  }
  ...
  private EditorCell createRefNodeList_iuuvkg_b1a(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Module_Editor.entitiesListHandler_iuuvkg_b1a(node, "entities", editorContext);
  ...
  private static class entitiesListHandler_iuuvkg_b1a extends RefNodeListHandler {
    public entitiesListHandler_iuuvkg_b1a(SNode ownerNode, String childRole, EditorContext context) {
