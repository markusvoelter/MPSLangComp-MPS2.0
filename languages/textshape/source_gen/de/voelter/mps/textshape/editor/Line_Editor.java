...
public class Line_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createCollection_78ent8_a(EditorContext editorContext, SNode node) {
    ...
    editorCell.addEditorCell(this.createRefNode_78ent8_a0(editorContext, node));
    return editorCell;
  }

  private EditorCell createRefNode_78ent8_a0(EditorContext editorContext, SNode node) {
